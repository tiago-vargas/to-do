...
relm4::new_stateless_action!(Quit, AppActions, "quit");

relm4::new_action_group!(pub WinActions, "win");
relm4::new_stateless_action!(pub ShowKeyboardShortcuts, WinActions, "show-help-overlay");
